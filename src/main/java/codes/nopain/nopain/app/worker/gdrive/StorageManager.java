...
public class StorageManager implements IStorageManager {
    ...
    public StorageManager() throws GeneralSecurityException, IOException {
    ...
    @Override
    public void uploadFile(InputStream inputStream, String parentId, String filename, FileType fileType) throws IOException {
    ...
    public void deleteFiles(String parentId, String filenameWithoutExtension) throws IOException {
        String query = String.format(
                "trashed = false and '%s' in parents and name contains '%s'",
                parentId, filenameWithoutExtension
        );
